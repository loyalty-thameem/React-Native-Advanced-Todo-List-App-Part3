...
import {Text,View,TouchableOpacity,StyleSheet,FlatList,KeyboardAvoidingView,TextInput,SafeAreaView} from 'react-native';
       ...
       <SafeAreaView style={styles.container}>
          ...
          <KeyboardAvoidingView style={[styles.section,styles.footer]} behavior='padding'>
            <TextInput style={[styles.input,{borderColor:this.state.color}]}/>
             <TouchableOpacity style={[styles.addTodo,{backgroundColor:this.state.color}]} onPress={this.props.closeModal}>
